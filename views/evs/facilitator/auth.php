<?php
    if(isset($_SESSION['userFacilitator'])){
        header("Location: /admin/facilitator");
    }
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <link rel="stylesheet" href="vendor/css/facilitator_style/auth.css" />
    ...
    <body>
        ...
        <script src="vendor/js/facilitator/login.js"></script>
    </body>
</html>
